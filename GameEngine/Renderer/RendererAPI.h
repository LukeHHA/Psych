...
public:
  ...
  virtual void DrawIndexed(const Shared<VertexArray>& vertexArray, const uint32_t indexCount)               = 0;
  static Expected<Unique<RendererAPI>, errors::RendererError> Create();
