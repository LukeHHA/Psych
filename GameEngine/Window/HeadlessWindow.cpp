...
namespace ge {
    ...
    HeadlessWindow::HeadlessWindow(const std::string& title, unsigned int width, unsigned int height) {
    ...
    util::expected<void, errors::WindowError> HeadlessWindow::Init(const std::string& title, unsigned int width, unsigned int height) {
        CORE_PROFILE_FUNCTION();
