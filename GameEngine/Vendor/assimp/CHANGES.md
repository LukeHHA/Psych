...
- Update\_ Use the latest ubuntu image and switch to ninja by @kimkulling in <https://github.com/assimp/assimp/pull/5114>
...
- Fix UNKNOWN WRITE in std::**1::list<Assimp::LWO::Envelope, std::**1::allocator<Assimp::LWO::Envelope> by @sashashura in <https://github.com/assimp/assimp/pull/5126>
...
- Fix UNKNOWN READ in std::**1::basic_string<char, std::**1::char_traits<char>, std::\_\_1::allocator<ch by @sashashura in <https://github.com/assimp/assimp/pull/5199>
...
- Fixes Heap-buffer-overflow in std::**1::basic_string<char, std::**1::… by @sashashura in <https://github.com/assimp/assimp/pull/4645>
...
- CMAKE: Respect top-level CMAKE\_\*\_OUTPUT_DIRECTORY variables by @leonvictor in <https://github.com/assimp/assimp/pull/4338>
...
- Common Stuff:
  ...
  - Introduce new log macros.
    -\_stat64 doesn't seem to exist. use \_\_stat64!
